...
public class ModeleSolution implements Modele {
    String solution;
    ModeleEnsLevels modeleEnsLevels;


    ModeleSolution(ModeleEnsLevels modeleEnsLevels){
        this.modeleEnsLevels=modeleEnsLevels;
    }
    ...
    public String resoudre(){
        System.out.println(convertLevel(modeleEnsLevels.getCurrentLevelString()));
        Sokoban s=new Sokoban(convertLevel(modeleEnsLevels.getCurrentLevelString()).split(","));
        solution=s.solve();
    ...
    public java.lang.String[][] getEtat() {
        return modeleEnsLevels.getEtat();
    }

    @Override
    public void chargerNiveau(java.lang.String[][] mapTmp) {
        modeleEnsLevels.chargerNiveau(mapTmp);
    }

    @Override
    public java.lang.String move(java.lang.String direction) {
        return modeleEnsLevels.move(direction);
    }

    @Override
    public void reset() {
            modeleEnsLevels.reset();
    }
}
